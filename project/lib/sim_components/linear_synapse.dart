...
class LinearSynapse extends Synapse {
  ...
  // Linear STDP traces
  Trace potTrace = Trace.createLinear(10.0, 5.0, 0.0);
  Trace depTrace = Trace.createLinear(5.0, 2.5, 0.0);
  Trace depAPTrace = Trace.createLinear(5.0, 1.5, 0.0);
  ...
  double integrate(double t) {
    ...
    if (synInput == 1) {
      ...
      synapseT = t;
      dt = 0.0;
      potTrace.reset(appState.properties.stepSize);
      depTrace.reset(appState.properties.stepSize);
    ...
    if (soma.output == 1) {
      ...
      depAPTrace.reset(appState.properties.stepSize);
